...
public class chaxunyuangong extends JFrame {
	...
	public chaxunyuangong() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"������", "��Ա����"}));
...
//					�����Ų�ѯ
					chaxundenji.showTable(model, "select * from worker where ID = '"
							+ textField.getText().trim() + "'");
				} else {
//					��Ա��������ѯ
					chaxundenji.showTable(model, "select * from worker where workerName = '"
							+ textField.getText().trim() + "'");
				}
				}
		});
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
//				��ѯȫ��
				chaxundenji.showTable(model, "select * from worker");
			}
		});
